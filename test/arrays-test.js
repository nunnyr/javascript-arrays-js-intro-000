...
=======
    xit('did not make a copy of the array when removing the last element', ()=>{
>>>>>>> a7b44b87bb2769d5f17f3c17c6cf4b26d6454a7c
      const array = [1, 2, 3];
  ...
  describe('removeElementFromEndOfArray(array)', () => {
    xit('removes the last element from the `array`', () => {
